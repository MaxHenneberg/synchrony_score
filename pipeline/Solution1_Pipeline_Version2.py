...
def filterBatchesWithLowEnergy(user1, user2):
    ...
    mean = ((meanUser1 + meanUser2) / 2) * meanPercentage
...
print(f'Before Filter {len(user1)}')
...
print(f'After Filter {len(notNullUser2)}')
...
plt.tight_layout()
DataUtil.savePlot(plt, 'Solution1', f'Version2-{int(meanPercentage*100)}')
